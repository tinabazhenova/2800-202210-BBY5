...
INSERT INTO BBY_05_master (phrase, meaning, history, xvalue) VALUES ('Go postal', 'To suddenly behave in a very violent or angry way', 'The expression derives from a series of incidents from 1986 onward with USPS', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, yvalue) VALUES ('Salty', 'Angry, irritated or hostile', 'U.S. slang sense of ""angry, irritated"" is first attested 1938 (probably from similar use with regard to sailors, ""tough, aggressive,"" attested by 1920)', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, zvalue) VALUES ('No Cap', 'Meant to convey authenticity and truth.', 'In the 1940s, according to Green''s Dictionary of Slang, to cap is evidenced as slang meaning ""to surpass,"" connected to the ritualized insults of capping (1960s)', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, bbvalue) VALUES ('thong', 'A light sandal with a thong between the big and second toe.', '""Thong"" comes from words meaning ""restraint,"" according to The Oxford English Dictionary, and was originally a narrow strip of leather used to secure something.', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, bbvalue) VALUES ('Gas of a time', 'A popular slang term in the 1960s, a `gas` was any activity or event that was either fun or inspired you to laugh', ' The first is the expression `everything is gas and goiters,` which is first found in print used by Charles Dickens in 1839, meaning quite satisfactory', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, bbvalue) VALUES ('Don``t flip your wig', "Use it to tell someone to calm down. ", 'Contrary to popular belief, it is not an old phrase, but was born in North America. The Oxford English Dictionary has the first print appearance listed in 1952.', 200);
INSERT INTO BBY_05_master (phrase, meaning, history, zvalue) VALUES ("Simp", "Short for simpleton and of showing excessive sympathy and attention toward another", "The 'New Partridge Dictionary of Slang and Unconventional English,' defines it as a shortened version of simpleton, so the phrase''s original meaning is rooted in calling someone stupid. The dictionary lists its first known usage as 1946, though it appeared in The New York Times as early as 1923", 200);
INSERT INTO BBY_05_master (phrase, meaning, history, xvalue) VALUES ("Word", "You're right", "The phrase 'word' originally came from saying that your word is your bond, and it was shortened to just 'word.'", 200);
